<template>
   <div class="text-3xl ml-10 my-10"></div>
    <footer
        class="flex flex-col items-center bg-zinc-80 text-center text-surface dark:bg-neutral-700 dark:text-white">
        <div class="w-full bg-slate-300">

            <!-- Social media icons container -->
            <div class="mb-6 flex justify-center space-x-2"></div>
                <a>
                    <h1 class="text-4xl">Follow in the same footsteps</h1>
                    <br>
                    <h4>as these amazing players who are currently living the dream.</h4>
                    <h4>Schedule a free introduction call</h4>
                </a>
            ...
            <div class="flex items-start">
                <img src="@/assets/Navbar/logoName.png" alt="Logo" class="h-10 ml-20 mt-4 block" />
            </div>
    ...
    <!-- <img src="@/assets/Navbar/logoName.png" alt="Logo" class="h-10 ml-20 mt-4 block" /> -->
            ...
            <div class="grid md:grid-cols-1 lg:grid-cols-2  ">
                <div class=" mb-2 px-[120px] ml-[30rem] ">
                    <ul class=" text-blue-500 list-none ">
                ...
                <div class="mb-2 px-[120px] ml-[1rem]">
                    <ul class="text-blue-500 list-none">
                    <li class="flex items-center gap-2">
                        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <div class="mb-2 px-[120px] ml-[30rem] ">
                    ...
                    <li class="flex items-center gap-2">
                        ...
                        <a href="#!">Sportsphere@gmail.com</a>
                    </li>
                    </ul>
                </div>
                ...
                <div class="mb-2 px-[120px] ml-[1rem]">
                    ...
                    <li class="flex items-center gap-2">
                        ...
                        <a href="#!">114 Toul Kork Phnom Penh</a>
                    </li>
                    </ul>
                </div>
            </div>
